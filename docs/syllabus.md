...
4. introduce the security, privacy, and reliability risks of AI-enabled systems;
5. strengthen students’ critical judgement on the responsible and trustworthy deployment of AI in cybersecurity contexts.
...
2. **Prepare and analyse** cybersecurity datasets using appropriate preprocessing and exploratory methods.
3. **Apply and compare** suitable AI or machine learning methods for a defined cybersecurity task.
4. **Evaluate critically** the effectiveness and operational limitations of AI-based cybersecurity systems.
5. **Explain and assess** key attacks against AI systems, including adversarial machine learning and large language model risks.
6. **Communicate** technical findings and deployment recommendations clearly in written and practical forms.
